...
# Gmail domain authentication settings
AUTHENTICATION_BACKENDS = [
    'config.settings.gmail_auth.GmailDomainBackend',
    'django.contrib.auth.backends.ModelBackend',
]

# Gmail whitelist settings
ALLOWED_GMAIL_DOMAINS = env.list("ALLOWED_GMAIL_DOMAINS", ["gmail.com"])
